    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {likeMarkEntity.deletedDate ? <TextFormat value={likeMarkEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
          ...
          <dt>
            <Translate contentKey="monsterdamChicksApp.likeMark.liker">Liker</Translate>
          </dt>
          <dd>{likeMarkEntity.liker ? likeMarkEntity.liker.id : ''}</dd>
        </dl>
