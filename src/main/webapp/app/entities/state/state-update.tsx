...
export const StateUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.countryId !== undefined && typeof values.countryId !== 'number') {
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.state.isDeleted')}
                id="state-isDeleted"
                name="isDeleted"
                data-cy="isDeleted"
                check
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.state.countryId')}
                id="state-countryId"
                name="countryId"
                data-cy="countryId"
                type="text"
