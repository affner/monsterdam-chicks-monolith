    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="isDeleted">
              <Translate contentKey="monsterdamChicksApp.commentMention.isDeleted">Is Deleted</Translate>
            </span>
          </dt>
          <dd>{commentMentionEntity.isDeleted ? 'true' : 'false'}</dd>
          <dt>
            <span id="mentionedUserId">
              <Translate contentKey="monsterdamChicksApp.commentMention.mentionedUserId">Mentioned User Id</Translate>
            </span>
          </dt>
          <dd>{commentMentionEntity.mentionedUserId}</dd>
          <dt>
