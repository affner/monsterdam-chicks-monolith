...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTMENTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMENTMENTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMENTMENTION actions', async () => {
      const arg = { id: 13625 };
    ...
    it('dispatches UPDATE_COMMENTMENTION actions', async () => {
      const arg = { id: 13625 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTMENTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMENTMENTION actions', async () => {
      const arg = 42666;
