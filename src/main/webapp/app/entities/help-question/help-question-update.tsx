...
export const HelpQuestionUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...helpQuestionEntity,
          createdDate: convertDateTimeFromServer(helpQuestionEntity.createdDate),
          lastModifiedDate: convertDateTimeFromServer(helpQuestionEntity.lastModifiedDate),
          deletedDate: convertDateTimeFromServer(helpQuestionEntity.deletedDate),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.helpQuestion.createdDate')}
                id="help-question-createdDate"
                name="createdDate"
                data-cy="createdDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.helpQuestion.lastModifiedDate')}
                id="help-question-lastModifiedDate"
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.helpQuestion.createdBy')}
                id="help-question-createdBy"
                name="createdBy"
                data-cy="createdBy"
                type="text"
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.helpQuestion.lastModifiedBy')}
                id="help-question-lastModifiedBy"
                name="lastModifiedBy"
                data-cy="lastModifiedBy"
                type="text"
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.helpQuestion.deletedDate')}
                id="help-question-deletedDate"
                name="deletedDate"
                data-cy="deletedDate"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
