...
import { deleteEntity, getEntity } from './help-question.reducer';
...
export const HelpQuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.helpQuestion.delete.question">
        <Translate contentKey="monsterdamChicksApp.helpQuestion.delete.question" interpolate={{ id: helpQuestionEntity.id }}>
