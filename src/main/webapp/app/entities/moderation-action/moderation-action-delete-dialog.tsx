...
import { deleteEntity, getEntity } from './moderation-action.reducer';
...
export const ModerationActionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.moderationAction.delete.question">
        <Translate contentKey="monsterdamChicksApp.moderationAction.delete.question" interpolate={{ id: moderationActionEntity.id }}>
