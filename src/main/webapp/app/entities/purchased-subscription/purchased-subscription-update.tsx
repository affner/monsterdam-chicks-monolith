        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.purchasedSubscription.isDeleted')}
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.purchasedSubscription.viewerId')}
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.purchasedSubscription.creatorId')}
