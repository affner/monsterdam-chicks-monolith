    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {purchasedSubscriptionEntity.deletedDate ? (
              <TextFormat value={purchasedSubscriptionEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>{purchasedSubscriptionEntity.creator ? purchasedSubscriptionEntity.creator.id : ''}</dd>
          <dt>
