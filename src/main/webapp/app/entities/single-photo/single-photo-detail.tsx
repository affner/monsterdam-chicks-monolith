    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {singlePhotoEntity.deletedDate ? (
              <TextFormat value={singlePhotoEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dt>
            <Translate contentKey="monsterdamChicksApp.singlePhoto.creator">Creator</Translate>
          </dt>
          <dd>{singlePhotoEntity.creator ? singlePhotoEntity.creator.id : ''}</dd>
        </dl>
