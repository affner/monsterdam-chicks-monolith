    ...
    <Row>
      <Col md="8">
        <h2 data-cy="pollOptionDetailsHeading">
          <Translate contentKey="monsterdamChicksApp.pollOption.detail.title">PollOption</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="monsterdamChicksApp.pollOption.poll">Poll</Translate>
          </dt>
          <dd>{pollOptionEntity.poll ? pollOptionEntity.poll.id : ''}</dd>
        </dl>
