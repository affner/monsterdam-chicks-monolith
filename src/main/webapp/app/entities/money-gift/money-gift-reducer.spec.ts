...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONEYGIFT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONEYGIFT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONEYGIFT actions', async () => {
      const arg = { id: 12872 };
    ...
    it('dispatches UPDATE_MONEYGIFT actions', async () => {
      const arg = { id: 12872 };
    ...
    it('dispatches PARTIAL_UPDATE_MONEYGIFT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONEYGIFT actions', async () => {
      const arg = 42666;
