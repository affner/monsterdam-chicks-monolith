...
import { deleteEntity, getEntity } from './hash-tag.reducer';
...
export const HashTagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.hashTag.delete.question">
        <Translate contentKey="monsterdamChicksApp.hashTag.delete.question" interpolate={{ id: hashTagEntity.id }}>
