...
import { getEntities } from './identity-document-review.reducer';
...
export const IdentityDocumentReview = () => {
  ...
  const identityDocumentReviewList = useAppSelector(state => state.identityDocumentReview.entities);
  const loading = useAppSelector(state => state.identityDocumentReview.loading);
  const totalItems = useAppSelector(state => state.identityDocumentReview.totalItems);
  ...
  return (
    <div>
      <h2 id="identity-document-review-heading" data-cy="IdentityDocumentReviewHeading">
        <Translate contentKey="monsterdamChicksApp.identityDocumentReview.home.title">Identity Document Reviews</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="monsterdamChicksApp.identityDocumentReview.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="monsterdamChicksApp.identityDocumentReview.home.createLabel">
              Create new Identity Document Review
            </Translate>
          </Link>
        </div>
      </h2>
        ...
        {identityDocumentReviewList && identityDocumentReviewList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="monsterdamChicksApp.identityDocumentReview.id">ID</Translate>{' '}
            ...
            <tbody>
              {identityDocumentReviewList.map((identityDocumentReview, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`monsterdamChicksApp.DocumentStatus.${identityDocumentReview.documentStatus}`} />
                  </td>
                  <td>
                  ...
                  <td>
                    <Translate contentKey={`monsterdamChicksApp.ReviewStatus.${identityDocumentReview.reviewStatus}`} />
                  </td>
                  <td>
                  ...
                  <td>{identityDocumentReview.ticketId}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monsterdamChicksApp.identityDocumentReview.home.notFound">
                No Identity Document Reviews found
              </Translate>
            </div>
          )
        )}
