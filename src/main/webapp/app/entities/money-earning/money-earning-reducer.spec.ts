...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONEYEARNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONEYEARNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONEYEARNING actions', async () => {
      const arg = { id: 27442 };
    ...
    it('dispatches UPDATE_MONEYEARNING actions', async () => {
      const arg = { id: 27442 };
    ...
    it('dispatches PARTIAL_UPDATE_MONEYEARNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONEYEARNING actions', async () => {
      const arg = 42666;
