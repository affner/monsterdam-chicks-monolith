...
import { deleteEntity, getEntity } from './social-network.reducer';
...
export const SocialNetworkDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.socialNetwork.delete.question">
        <Translate contentKey="monsterdamChicksApp.socialNetwork.delete.question" interpolate={{ id: socialNetworkEntity.id }}>
