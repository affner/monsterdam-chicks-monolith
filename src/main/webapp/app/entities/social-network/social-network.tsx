...
import { getEntities } from './social-network.reducer';
...
export const SocialNetwork = () => {
  ...
  const socialNetworkList = useAppSelector(state => state.socialNetwork.entities);
  const loading = useAppSelector(state => state.socialNetwork.loading);
  const totalItems = useAppSelector(state => state.socialNetwork.totalItems);
  ...
  return (
    <div>
      <h2 id="social-network-heading" data-cy="SocialNetworkHeading">
        <Translate contentKey="monsterdamChicksApp.socialNetwork.home.title">Social Networks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="monsterdamChicksApp.socialNetwork.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/social-network/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="monsterdamChicksApp.socialNetwork.home.createLabel">Create new Social Network</Translate>
          </Link>
        </div>
      </h2>
        ...
        {socialNetworkList && socialNetworkList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="monsterdamChicksApp.socialNetwork.id">ID</Translate>{' '}
            ...
            <tbody>
              {socialNetworkList.map((socialNetwork, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {socialNetwork.deletedDate ? (
                      <TextFormat type="date" value={socialNetwork.deletedDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monsterdamChicksApp.socialNetwork.home.notFound">No Social Networks found</Translate>
            </div>
          )
        )}
      </div>
