  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          deletedDate: convertDateTimeFromServer(videoStoryEntity.deletedDate),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.videoStory.deletedDate')}
                id="video-story-deletedDate"
                name="deletedDate"
                data-cy="deletedDate"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              ...
              <ValidatedField
                ...
                name="creator"
                data-cy="creator"
                label={translate('monsterdamChicksApp.videoStory.creator')}
                type="select"
                required
              >
                <option value="" key="0" />
