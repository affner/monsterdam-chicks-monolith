...
import { deleteEntity, getEntity } from './video-story.reducer';
...
export const VideoStoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.videoStory.delete.question">
        <Translate contentKey="monsterdamChicksApp.videoStory.delete.question" interpolate={{ id: videoStoryEntity.id }}>
