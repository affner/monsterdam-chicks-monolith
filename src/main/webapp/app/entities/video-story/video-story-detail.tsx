    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {videoStoryEntity.deletedDate ? <TextFormat value={videoStoryEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.videoStory.creator">Creator</Translate>
          </dt>
