...
import { deleteEntity, getEntity } from './admin-system-configs.reducer';
...
export const AdminSystemConfigsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.adminSystemConfigs.delete.question">
        <Translate contentKey="monsterdamChicksApp.adminSystemConfigs.delete.question" interpolate={{ id: adminSystemConfigsEntity.id }}>
