    ...
    <Row>
      <Col md="8">
        <h2 data-cy="adminSystemConfigsDetailsHeading">
          <Translate contentKey="monsterdamChicksApp.adminSystemConfigs.detail.title">AdminSystemConfigs</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            {adminSystemConfigsEntity.deletedDate ? (
              <TextFormat value={adminSystemConfigsEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
        </dl>
