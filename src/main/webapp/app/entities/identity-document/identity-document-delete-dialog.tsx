...
export const IdentityDocumentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.identityDocument.delete.question">
        <Translate contentKey="monsterdamChicksApp.identityDocument.delete.question" interpolate={{ id: identityDocumentEntity.id }}>
