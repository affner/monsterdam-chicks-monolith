...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.payment.delete.question">
        <Translate contentKey="monsterdamChicksApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
