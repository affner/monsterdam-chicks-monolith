...
export const UserSettings = () => {
  ...
  const userSettingsList = useAppSelector(state => state.userSettings.entities);
  const loading = useAppSelector(state => state.userSettings.loading);
  const totalItems = useAppSelector(state => state.userSettings.totalItems);
  ...
  return (
    <div>
      <h2 id="user-settings-heading" data-cy="UserSettingsHeading">
        <Translate contentKey="monsterdamChicksApp.userSettings.home.title">User Settings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="monsterdamChicksApp.userSettings.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-settings/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="monsterdamChicksApp.userSettings.home.createLabel">Create new User Settings</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userSettingsList && userSettingsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('darkMode')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.darkMode">Dark Mode</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('darkMode')} />
                </th>
                <th className="hand" onClick={sort('language')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.language">Language</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('language')} />
                </th>
                <th className="hand" onClick={sort('contentFilter')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.contentFilter">Content Filter</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('contentFilter')} />
                </th>
                <th className="hand" onClick={sort('messageBlurIntensity')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.messageBlurIntensity">Message Blur Intensity</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('messageBlurIntensity')} />
                </th>
                <th className="hand" onClick={sort('activityStatusVisibility')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.activityStatusVisibility">Activity Status Visibility</Translate>{' '}
                ...
                <th className="hand" onClick={sort('twoFactorAuthentication')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.twoFactorAuthentication">Two Factor Authentication</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('twoFactorAuthentication')} />
                </th>
                <th className="hand" onClick={sort('sessionsActiveCount')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.sessionsActiveCount">Sessions Active Count</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('sessionsActiveCount')} />
                </th>
                <th className="hand" onClick={sort('emailNotifications')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.emailNotifications">Email Notifications</Translate>{' '}
                ...
                <th className="hand" onClick={sort('importantSubscriptionNotifications')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.importantSubscriptionNotifications">
                ...
                <th className="hand" onClick={sort('siteNewStream')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.siteNewStream">Site New Stream</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('siteNewStream')} />
                </th>
                <th className="hand" onClick={sort('siteUpcomingStreamReminders')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.siteUpcomingStreamReminders">
                    Site Upcoming Stream Reminders
                  </Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('siteUpcomingStreamReminders')} />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.createdDate">Created Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
                </th>
                <th className="hand" onClick={sort('lastModifiedDate')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.lastModifiedDate">Last Modified Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
                </th>
                <th className="hand" onClick={sort('createdBy')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.createdBy">Created By</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdBy')} />
                </th>
                <th className="hand" onClick={sort('lastModifiedBy')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.lastModifiedBy">Last Modified By</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
                </th>
                <th className="hand" onClick={sort('deletedDate')}>
                  <Translate contentKey="monsterdamChicksApp.userSettings.deletedDate">Deleted Date</Translate>{' '}
            ...
            <tbody>
              {userSettingsList.map((userSettings, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`monsterdamChicksApp.UserLanguage.${userSettings.language}`} />
                  </td>
                  ...
                  <td>
                    {userSettings.deletedDate ? <TextFormat type="date" value={userSettings.deletedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monsterdamChicksApp.userSettings.home.notFound">No User Settings found</Translate>
            </div>
          )
        )}
      </div>
