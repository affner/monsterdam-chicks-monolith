...
export const FeedbackDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.feedback.delete.question">
        <Translate contentKey="monsterdamChicksApp.feedback.delete.question" interpolate={{ id: feedbackEntity.id }}>
