    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="deletedDate">
              <Translate contentKey="monsterdamChicksApp.country.deletedDate">Deleted Date</Translate>
            </span>
          </dt>
          <dd>
            {countryEntity.deletedDate ? <TextFormat value={countryEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
        </dl>
