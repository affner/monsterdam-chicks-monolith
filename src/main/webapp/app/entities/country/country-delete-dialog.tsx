...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.country.delete.question">
        <Translate contentKey="monsterdamChicksApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
