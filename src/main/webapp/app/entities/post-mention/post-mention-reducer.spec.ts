...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTMENTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTMENTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTMENTION actions', async () => {
      const arg = { id: 8875 };
    ...
    it('dispatches UPDATE_POSTMENTION actions', async () => {
      const arg = { id: 8875 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTMENTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTMENTION actions', async () => {
      const arg = 42666;
