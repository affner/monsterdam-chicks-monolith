            ...
            <tbody>
              {postMentionList.map((postMention, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {postMention.deletedDate ? <TextFormat type="date" value={postMention.deletedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {postMention.originPost ? <Link to={`/post-feed/${postMention.originPost.id}`}>{postMention.originPost.id}</Link> : ''}
                  </td>
                  <td>
                    {postMention.mentionedUser ? (
                      <Link to={`/user-lite/${postMention.mentionedUser.id}`}>{postMention.mentionedUser.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
