...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.notification.delete.question">
        <Translate contentKey="monsterdamChicksApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
