          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monsterdamChicksApp.notification.recipient">Recipient</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="monsterdamChicksApp.notification.actor">Actor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {notification.recipient ? <Link to={`/user-lite/${notification.recipient.id}`}>{notification.recipient.id}</Link> : ''}
                  </td>
                  <td>{notification.actor ? <Link to={`/user-lite/${notification.actor.id}`}>{notification.actor.id}</Link> : ''}</td>
