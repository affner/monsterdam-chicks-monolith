...
import { deleteEntity, getEntity } from './assistance-ticket.reducer';
...
export const AssistanceTicketDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.assistanceTicket.delete.question">
        <Translate contentKey="monsterdamChicksApp.assistanceTicket.delete.question" interpolate={{ id: assistanceTicketEntity.id }}>
