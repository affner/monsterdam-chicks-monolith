          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monsterdamChicksApp.assistanceTicket.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {assistanceTicketList.map((assistanceTicket, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {assistanceTicket.user ? <Link to={`/user-lite/${assistanceTicket.user.id}`}>{assistanceTicket.user.id}</Link> : ''}
                  </td>
