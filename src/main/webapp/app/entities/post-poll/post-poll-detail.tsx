    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {postPollEntity.deletedDate ? <TextFormat value={postPollEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.postPoll.post">Post</Translate>
          </dt>
          <dd>{postPollEntity.post ? postPollEntity.post.id : ''}</dd>
        </dl>
