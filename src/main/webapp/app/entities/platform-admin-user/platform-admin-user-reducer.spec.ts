...
import reducer, {
  ...
  reset,
  updateEntity,
} from './platform-admin-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLATFORMADMINUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLATFORMADMINUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLATFORMADMINUSER actions', async () => {
      const arg = { id: 24249 };
    ...
    it('dispatches UPDATE_PLATFORMADMINUSER actions', async () => {
      const arg = { id: 24249 };
    ...
    it('dispatches PARTIAL_UPDATE_PLATFORMADMINUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PLATFORMADMINUSER actions', async () => {
      const arg = 42666;
