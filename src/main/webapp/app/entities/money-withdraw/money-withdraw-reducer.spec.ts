...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONEYWITHDRAW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONEYWITHDRAW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONEYWITHDRAW actions', async () => {
      const arg = { id: 28170 };
    ...
    it('dispatches UPDATE_MONEYWITHDRAW actions', async () => {
      const arg = { id: 28170 };
    ...
    it('dispatches PARTIAL_UPDATE_MONEYWITHDRAW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONEYWITHDRAW actions', async () => {
      const arg = 42666;
