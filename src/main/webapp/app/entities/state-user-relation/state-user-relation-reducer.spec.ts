...
import reducer, {
  ...
  reset,
  updateEntity,
} from './state-user-relation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEUSERRELATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATEUSERRELATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATEUSERRELATION actions', async () => {
      const arg = { id: 3734 };
    ...
    it('dispatches UPDATE_STATEUSERRELATION actions', async () => {
      const arg = { id: 3734 };
    ...
    it('dispatches PARTIAL_UPDATE_STATEUSERRELATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATEUSERRELATION actions', async () => {
      const arg = 42666;
