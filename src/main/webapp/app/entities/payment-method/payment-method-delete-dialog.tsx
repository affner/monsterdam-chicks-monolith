...
export const PaymentMethodDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.paymentMethod.delete.question">
        <Translate contentKey="monsterdamChicksApp.paymentMethod.delete.question" interpolate={{ id: paymentMethodEntity.id }}>
