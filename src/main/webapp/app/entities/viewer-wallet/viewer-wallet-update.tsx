        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.viewerWallet.isDeleted')}
                id="viewer-wallet-isDeleted"
                name="isDeleted"
                data-cy="isDeleted"
                check
                type="checkbox"
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.viewerWallet.viewerId')}
                id="viewer-wallet-viewerId"
                name="viewerId"
                data-cy="viewerId"
                type="text"
                validate={{
