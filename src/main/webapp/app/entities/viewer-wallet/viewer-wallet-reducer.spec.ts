...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIEWERWALLET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIEWERWALLET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIEWERWALLET actions', async () => {
      const arg = { id: 134 };
    ...
    it('dispatches UPDATE_VIEWERWALLET actions', async () => {
      const arg = { id: 134 };
    ...
    it('dispatches PARTIAL_UPDATE_VIEWERWALLET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIEWERWALLET actions', async () => {
      const arg = 42666;
