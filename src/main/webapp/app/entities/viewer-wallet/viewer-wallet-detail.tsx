    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{viewerWalletEntity.currency}</dd>
          <dt>
          ...
          <dd>
            {viewerWalletEntity.deletedDate ? (
              <TextFormat value={viewerWalletEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dt>
            <Translate contentKey="monsterdamChicksApp.viewerWallet.viewer">Viewer</Translate>
          </dt>
          <dd>{viewerWalletEntity.viewer ? viewerWalletEntity.viewer.id : ''}</dd>
        </dl>
