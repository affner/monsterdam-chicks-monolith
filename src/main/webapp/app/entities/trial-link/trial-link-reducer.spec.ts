...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIALLINK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIALLINK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIALLINK actions', async () => {
      const arg = { id: 7985 };
    ...
    it('dispatches UPDATE_TRIALLINK actions', async () => {
      const arg = { id: 7985 };
    ...
    it('dispatches PARTIAL_UPDATE_TRIALLINK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRIALLINK actions', async () => {
      const arg = 42666;
