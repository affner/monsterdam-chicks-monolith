...
export const LedgerEntryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.ledgerEntry.delete.question">
        <Translate contentKey="monsterdamChicksApp.ledgerEntry.delete.question" interpolate={{ id: ledgerEntryEntity.id }}>
