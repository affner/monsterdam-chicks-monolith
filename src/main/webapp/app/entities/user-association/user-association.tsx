          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monsterdamChicksApp.userAssociation.owner">Owner</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userAssociationList.map((userAssociation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {userAssociation.deletedDate ? (
                      <TextFormat type="date" value={userAssociation.deletedDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {userAssociation.owner ? <Link to={`/user-lite/${userAssociation.owner.id}`}>{userAssociation.owner.id}</Link> : ''}
                  </td>
