...
import reducer, {
  ...
  reset,
  updateEntity,
} from './payment-provider-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTPROVIDEREVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTPROVIDEREVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTPROVIDEREVENT actions', async () => {
      const arg = { id: 9040 };
    ...
    it('dispatches UPDATE_PAYMENTPROVIDEREVENT actions', async () => {
      const arg = { id: 9040 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTPROVIDEREVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTPROVIDEREVENT actions', async () => {
      const arg = 42666;
