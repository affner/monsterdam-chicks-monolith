    ...
    <Row>
      <Col md="8">
        <h2 data-cy="pollVoteDetailsHeading">
          <Translate contentKey="monsterdamChicksApp.pollVote.detail.title">PollVote</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="votingUserId">
              <Translate contentKey="monsterdamChicksApp.pollVote.votingUserId">Voting User Id</Translate>
            </span>
          </dt>
          <dd>{pollVoteEntity.votingUserId}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.pollVote.pollOption">Poll Option</Translate>
          </dt>
          <dd>{pollVoteEntity.pollOption ? pollVoteEntity.pollOption.id : ''}</dd>
        </dl>
