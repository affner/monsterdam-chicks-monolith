            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isDeleted')}>
                  <Translate contentKey="monsterdamChicksApp.postComment.isDeleted">Is Deleted</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('isDeleted')} />
                </th>
                <th className="hand" onClick={sort('commenterId')}>
                  <Translate contentKey="monsterdamChicksApp.postComment.commenterId">Commenter Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('commenterId')} />
                </th>
                <th>
