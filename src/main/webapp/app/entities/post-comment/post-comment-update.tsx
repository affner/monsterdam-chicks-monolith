...
export const PostCommentUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...
      commenter: userLites.find(it => it.id.toString() === values.commenter?.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          deletedDate: convertDateTimeFromServer(postCommentEntity.deletedDate),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('monsterdamChicksApp.postComment.deletedDate')}
                id="post-comment-deletedDate"
                name="deletedDate"
                data-cy="deletedDate"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              ...
              <ValidatedField
                ...
                name="commenter"
                data-cy="commenter"
                label={translate('monsterdamChicksApp.postComment.commenter')}
                type="select"
                required
              >
                <option value="" key="0" />
