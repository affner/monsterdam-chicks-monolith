...
import reducer, {
  ...
  reset,
  updateEntity,
} from './refund-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFUNDTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REFUNDTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REFUNDTRANSACTION actions', async () => {
      const arg = { id: 23943 };
    ...
    it('dispatches UPDATE_REFUNDTRANSACTION actions', async () => {
      const arg = { id: 23943 };
    ...
    it('dispatches PARTIAL_UPDATE_REFUNDTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REFUNDTRANSACTION actions', async () => {
      const arg = 42666;
