    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="deletedDate">
              <Translate contentKey="monsterdamChicksApp.subscriptionBundle.deletedDate">Deleted Date</Translate>
            </span>
          </dt>
          <dd>
            {subscriptionBundleEntity.deletedDate ? (
              <TextFormat value={subscriptionBundleEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
