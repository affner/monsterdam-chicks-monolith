...
import { deleteEntity, getEntity } from './document-review-observation.reducer';
...
export const DocumentReviewObservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.documentReviewObservation.delete.question">
        <Translate
          contentKey="monsterdamChicksApp.documentReviewObservation.delete.question"
          interpolate={{ id: documentReviewObservationEntity.id }}
        >
