    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bookMarkDetailsHeading">
          <Translate contentKey="monsterdamChicksApp.bookMark.detail.title">BookMark</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>
            {bookMarkEntity.deletedDate ? <TextFormat value={bookMarkEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.bookMark.user">User</Translate>
          </dt>
          <dd>{bookMarkEntity.user ? bookMarkEntity.user.id : ''}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.bookMark.post">Post</Translate>
          </dt>
          <dd>{bookMarkEntity.post ? bookMarkEntity.post.id : ''}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.bookMark.message">Message</Translate>
          </dt>
          <dd>{bookMarkEntity.message ? bookMarkEntity.message.id : ''}</dd>
        </dl>
