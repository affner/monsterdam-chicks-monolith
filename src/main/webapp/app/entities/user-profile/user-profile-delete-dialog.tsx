...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.userProfile.delete.question">
        <Translate contentKey="monsterdamChicksApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
