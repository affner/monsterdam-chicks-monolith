...
import { deleteEntity, getEntity } from './user-report.reducer';
...
export const UserReportDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.userReport.delete.question">
        <Translate contentKey="monsterdamChicksApp.userReport.delete.question" interpolate={{ id: userReportEntity.id }}>
