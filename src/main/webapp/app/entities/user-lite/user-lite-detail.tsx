    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {userLiteEntity.deletedDate ? <TextFormat value={userLiteEntity.deletedDate} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <span id="nickName">
          ...
          <dt>
            <Translate contentKey="monsterdamChicksApp.userLite.chatRooms">Chat Rooms</Translate>
          </dt>
          <dd>
            {userLiteEntity.chatRooms
              ? userLiteEntity.chatRooms.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {userLiteEntity.chatRooms && i === userLiteEntity.chatRooms.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
