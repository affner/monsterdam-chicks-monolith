...
import { deleteEntity, getEntity } from './user-lite.reducer';
...
export const UserLiteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.userLite.delete.question">
        <Translate contentKey="monsterdamChicksApp.userLite.delete.question" interpolate={{ id: userLiteEntity.id }}>
