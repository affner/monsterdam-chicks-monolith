...
import { deleteEntity, getEntity } from './payment-provider.reducer';
...
export const PaymentProviderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.paymentProvider.delete.question">
        <Translate contentKey="monsterdamChicksApp.paymentProvider.delete.question" interpolate={{ id: paymentProviderEntity.id }}>
