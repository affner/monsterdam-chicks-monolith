    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="isDeleted">
              <Translate contentKey="monsterdamChicksApp.purchasedContent.isDeleted">Is Deleted</Translate>
            </span>
          </dt>
          <dd>{purchasedContentEntity.isDeleted ? 'true' : 'false'}</dd>
          <dt>
            <span id="viewerId">
              <Translate contentKey="monsterdamChicksApp.purchasedContent.viewerId">Viewer Id</Translate>
            </span>
          </dt>
          <dd>{purchasedContentEntity.viewerId}</dd>
          <dt>
