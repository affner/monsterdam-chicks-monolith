...
import { deleteEntity, getEntity } from './content-package.reducer';
...
export const ContentPackageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.contentPackage.delete.question">
        <Translate contentKey="monsterdamChicksApp.contentPackage.delete.question" interpolate={{ id: contentPackageEntity.id }}>
