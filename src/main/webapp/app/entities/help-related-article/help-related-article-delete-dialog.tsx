...
import { deleteEntity, getEntity } from './help-related-article.reducer';
...
export const HelpRelatedArticleDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.helpRelatedArticle.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.helpRelatedArticle.delete.question">
        <Translate contentKey="monsterdamChicksApp.helpRelatedArticle.delete.question" interpolate={{ id: helpRelatedArticleEntity.id }}>
