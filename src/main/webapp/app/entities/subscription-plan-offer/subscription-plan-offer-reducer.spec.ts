...
import reducer, {
  ...
  reset,
  updateEntity,
} from './subscription-plan-offer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONPLANOFFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSCRIPTIONPLANOFFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSCRIPTIONPLANOFFER actions', async () => {
      const arg = { id: 30384 };
    ...
    it('dispatches UPDATE_SUBSCRIPTIONPLANOFFER actions', async () => {
      const arg = { id: 30384 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONPLANOFFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSCRIPTIONPLANOFFER actions', async () => {
      const arg = 42666;
