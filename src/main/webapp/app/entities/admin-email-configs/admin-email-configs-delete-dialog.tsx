...
import { deleteEntity, getEntity } from './admin-email-configs.reducer';
...
export const AdminEmailConfigsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.adminEmailConfigs.delete.question">
        <Translate contentKey="monsterdamChicksApp.adminEmailConfigs.delete.question" interpolate={{ id: adminEmailConfigsEntity.id }}>
