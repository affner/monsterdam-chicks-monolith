    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="isDeleted">
              <Translate contentKey="monsterdamChicksApp.singleAudio.isDeleted">Is Deleted</Translate>
            </span>
          </dt>
          <dd>{singleAudioEntity.isDeleted ? 'true' : 'false'}</dd>
          <dt>
            <span id="creatorId">
              <Translate contentKey="monsterdamChicksApp.singleAudio.creatorId">Creator Id</Translate>
            </span>
          </dt>
          <dd>{singleAudioEntity.creatorId}</dd>
          <dt>
