...
import { deleteEntity, getEntity } from './admin-announcement.reducer';
...
export const AdminAnnouncementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.adminAnnouncement.delete.question">
        <Translate contentKey="monsterdamChicksApp.adminAnnouncement.delete.question" interpolate={{ id: adminAnnouncementEntity.id }}>
