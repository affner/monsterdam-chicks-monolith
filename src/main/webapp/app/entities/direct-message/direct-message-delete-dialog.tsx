...
import { deleteEntity, getEntity } from './direct-message.reducer';
...
export const DirectMessageDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/direct-message${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="monsterdamChicksApp.directMessage.delete.question">
        <Translate contentKey="monsterdamChicksApp.directMessage.delete.question" interpolate={{ id: directMessageEntity.id }}>
