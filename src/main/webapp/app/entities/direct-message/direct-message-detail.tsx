    ...
    <Row>
      <Col md="8">
        <h2 data-cy="directMessageDetailsHeading">
          <Translate contentKey="monsterdamChicksApp.directMessage.detail.title">DirectMessage</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="deletedDate">
              <Translate contentKey="monsterdamChicksApp.directMessage.deletedDate">Deleted Date</Translate>
            </span>
          </dt>
          <dd>
            {directMessageEntity.deletedDate ? (
              <TextFormat value={directMessageEntity.deletedDate} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="repliedStoryId">
              <Translate contentKey="monsterdamChicksApp.directMessage.repliedStoryId">Replied Story Id</Translate>
            </span>
          </dt>
          <dd>{directMessageEntity.repliedStoryId}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.directMessage.responseTo">Response To</Translate>
          </dt>
          <dd>{directMessageEntity.responseTo ? directMessageEntity.responseTo.id : ''}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.directMessage.chatRoom">Chat Room</Translate>
          </dt>
          <dd>{directMessageEntity.chatRoom ? directMessageEntity.chatRoom.id : ''}</dd>
          <dt>
            <Translate contentKey="monsterdamChicksApp.directMessage.sender">Sender</Translate>
          </dt>
          <dd>{directMessageEntity.sender ? directMessageEntity.sender.id : ''}</dd>
        </dl>
