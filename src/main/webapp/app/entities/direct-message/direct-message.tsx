          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monsterdamChicksApp.directMessage.sender">Sender</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {directMessageList.map((directMessage, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {directMessage.deletedDate ? (
                      <TextFormat type="date" value={directMessage.deletedDate} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
                  ...
                  <td>{directMessage.sender ? <Link to={`/user-lite/${directMessage.sender.id}`}>{directMessage.sender.id}</Link> : ''}</td>
