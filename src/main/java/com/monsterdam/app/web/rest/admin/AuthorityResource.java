...
/**
 * REST controller for managing {@link com.monsterdam.app.domain.Authority}.
 */
@RestController
@RequestMapping("/api/bff/admin/authorities")
@Transactional
public class AuthorityResource {
    ...
    public ResponseEntity<Authority> createAuthority(@Valid @RequestBody Authority authority) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/bff/admin/authorities/" + authority.getName()))
