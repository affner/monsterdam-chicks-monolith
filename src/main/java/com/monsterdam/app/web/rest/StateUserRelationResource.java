...
/**
 * REST controller for managing {@link com.monsterdam.app.domain.StateUserRelation}.
 */
@RestController
@RequestMapping("/api/state-user-relations")
public class StateUserRelationResource {

    private static final Logger LOG = LoggerFactory.getLogger(StateUserRelationResource.class);

    private static final String ENTITY_NAME = "stateUserRelation";
    ...
    public ResponseEntity<StateUserRelationDTO> createStateUserRelation(@Valid @RequestBody StateUserRelationDTO stateUserRelationDTO)
        ...
        stateUserRelationDTO = stateUserRelationService.save(stateUserRelationDTO);
        return ResponseEntity.created(new URI("/api/state-user-relations/" + stateUserRelationDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, stateUserRelationDTO.getId().toString()))
            .body(stateUserRelationDTO);
    }
    ...
    public ResponseEntity<StateUserRelationDTO> updateStateUserRelation(
        ...
        stateUserRelationDTO = stateUserRelationService.update(stateUserRelationDTO);
