...
import com.monsterdam.app.service.bff.admin.AdminUserBffService;
...
public class UserResource {
    ...
    private final AdminUserBffService adminUserBffService;

    private final UserRepository userRepository;

    private final MailService mailService;

    public UserResource(AdminUserBffService adminUserBffService, UserRepository userRepository, MailService mailService) {
        this.adminUserBffService = adminUserBffService;
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            User newUser = adminUserBffService.createUser(userDTO);
            mailService.sendCreationEmail(newUser);
            return ResponseEntity.created(new URI("/api/bff/admin/users/" + newUser.getLogin()))
    ...
    public ResponseEntity<AdminUserDTO> updateUser(
        ...
        Optional<AdminUserDTO> updatedUser = adminUserBffService.updateUser(userDTO);
    ...
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        final Page<AdminUserDTO> page = adminUserBffService.getAllManagedUsers(pageable);
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable("login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return ResponseUtil.wrapOrNotFound(adminUserBffService.getUserWithAuthoritiesByLogin(login).map(AdminUserDTO::new));
    }
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable("login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        adminUserBffService.deleteUser(login);
