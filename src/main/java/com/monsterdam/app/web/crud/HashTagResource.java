...
import com.monsterdam.app.service.HashTagService;
 ...
 */
@RestController
@RequestMapping("/api/crud/hash-tags")
public class HashTagResource {
    ...
    public ResponseEntity<HashTagDTO> createHashTag(@Valid @RequestBody HashTagDTO hashTagDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/crud/hash-tags/" + hashTagDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, hashTagDTO.getId().toString()))
            .body(hashTagDTO);
    }
    ...
    public ResponseEntity<HashTagDTO> updateHashTag(
        ...
        hashTagDTO = hashTagService.update(hashTagDTO);
