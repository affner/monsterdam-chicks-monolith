 ...
 */
@RestController
@RequestMapping("/api/crud/content-packages")
public class ContentPackageResource {
    ...
    public ResponseEntity<ContentPackageDTO> createContentPackage(@Valid @RequestBody ContentPackageDTO contentPackageDTO)
        ...
        contentPackageDTO = contentPackageService.save(contentPackageDTO);
        return ResponseEntity.created(new URI("/api/crud/content-packages/" + contentPackageDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, contentPackageDTO.getId().toString()))
    ...
    public ResponseEntity<ContentPackageDTO> updateContentPackage(
        ...
        contentPackageDTO = contentPackageService.update(contentPackageDTO);
