...
import com.monsterdam.app.service.NotificationService;
...
/**
 * REST controller for managing {@link com.monsterdam.app.domain.Notification}.
 */
@RestController
@RequestMapping("/api/crud/notifications")
public class NotificationResource {
    ...
    public ResponseEntity<NotificationDTO> createNotification(@Valid @RequestBody NotificationDTO notificationDTO)
        ...
        return ResponseEntity.created(new URI("/api/crud/notifications/" + notificationDTO.getId()))
