 ...
 */
@RestController
@RequestMapping("/api/crud/payment-providers")
public class PaymentProviderResource {
    ...
    public ResponseEntity<PaymentProviderDTO> createPaymentProvider(@Valid @RequestBody PaymentProviderDTO paymentProviderDTO)
        ...
        paymentProviderDTO = paymentProviderService.save(paymentProviderDTO);
        return ResponseEntity.created(new URI("/api/crud/payment-providers/" + paymentProviderDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, paymentProviderDTO.getId().toString()))
            .body(paymentProviderDTO);
    }
    ...
    public ResponseEntity<PaymentProviderDTO> updatePaymentProvider(
        ...
        paymentProviderDTO = paymentProviderService.update(paymentProviderDTO);
