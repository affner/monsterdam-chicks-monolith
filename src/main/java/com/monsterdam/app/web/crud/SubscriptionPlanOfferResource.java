 ...
 */
@RestController
@RequestMapping("/api/crud/subscription-plan-offers")
public class SubscriptionPlanOfferResource {
    ...
    public ResponseEntity<SubscriptionPlanOfferDTO> createSubscriptionPlanOffer(
        ...
        return ResponseEntity.created(new URI("/api/crud/subscription-plan-offers/" + subscriptionPlanOfferDTO.getId()))
