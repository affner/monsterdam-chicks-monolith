 ...
 */
@RestController
@RequestMapping("/api/crud/admin-email-configs")
public class AdminEmailConfigsResource {
    ...
    public ResponseEntity<AdminEmailConfigsDTO> createAdminEmailConfigs(@Valid @RequestBody AdminEmailConfigsDTO adminEmailConfigsDTO)
        ...
        adminEmailConfigsDTO = adminEmailConfigsService.save(adminEmailConfigsDTO);
        return ResponseEntity.created(new URI("/api/crud/admin-email-configs/" + adminEmailConfigsDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, adminEmailConfigsDTO.getId().toString()))
            .body(adminEmailConfigsDTO);
    }
    ...
    public ResponseEntity<AdminEmailConfigsDTO> updateAdminEmailConfigs(
        ...
        adminEmailConfigsDTO = adminEmailConfigsService.update(adminEmailConfigsDTO);
