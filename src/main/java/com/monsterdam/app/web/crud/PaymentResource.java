...
import com.monsterdam.app.service.PaymentService;
...
/**
 * REST controller for managing {@link com.monsterdam.app.domain.Payment}.
 */
@RestController
@RequestMapping("/api/crud/payments")
public class PaymentResource {
    ...
    public ResponseEntity<PaymentDTO> createPayment(@Valid @RequestBody PaymentDTO paymentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/crud/payments/" + paymentDTO.getId()))
