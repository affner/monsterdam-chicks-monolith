...
import com.monsterdam.app.service.FeedbackService;
 ...
 */
@RestController
@RequestMapping("/api/crud/feedbacks")
public class FeedbackResource {
    ...
    public ResponseEntity<FeedbackDTO> createFeedback(@Valid @RequestBody FeedbackDTO feedbackDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/crud/feedbacks/" + feedbackDTO.getId()))
