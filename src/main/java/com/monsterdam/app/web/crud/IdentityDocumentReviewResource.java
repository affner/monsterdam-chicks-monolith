 ...
 */
@RestController
@RequestMapping("/api/crud/identity-document-reviews")
public class IdentityDocumentReviewResource {
    ...
    public ResponseEntity<IdentityDocumentReviewDTO> createIdentityDocumentReview(
        ...
        return ResponseEntity.created(new URI("/api/crud/identity-document-reviews/" + identityDocumentReviewDTO.getId()))
