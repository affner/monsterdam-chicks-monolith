...
public class HelpSubcategory implements Serializable {
    ...
    public HelpSubcategory createdDate(Instant createdDate) {
    ...
    public HelpSubcategory lastModifiedDate(Instant lastModifiedDate) {
    ...
    public HelpSubcategory createdBy(String createdBy) {
    ...
    public HelpSubcategory lastModifiedBy(String lastModifiedBy) {
    ...
    public HelpSubcategory deletedDate(Instant deletedDate) {
