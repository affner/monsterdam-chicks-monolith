...
public class HelpRelatedArticle implements Serializable {
    ...
    public HelpRelatedArticle createdDate(Instant createdDate) {
    ...
    public HelpRelatedArticle lastModifiedDate(Instant lastModifiedDate) {
    ...
    public HelpRelatedArticle createdBy(String createdBy) {
    ...
    public HelpRelatedArticle lastModifiedBy(String lastModifiedBy) {
    ...
    public HelpRelatedArticle deletedDate(Instant deletedDate) {
