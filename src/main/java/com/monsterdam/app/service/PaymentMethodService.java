...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.PaymentMethod}.
 */
public interface PaymentMethodService extends LogicalDeletionService<PaymentMethodDTO> {
    /**
