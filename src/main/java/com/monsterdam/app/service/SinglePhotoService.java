...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.SinglePhoto}.
 */
public interface SinglePhotoService extends LogicalDeletionService<SinglePhotoDTO> {
    /**
     * Save a singlePhoto.
     *
