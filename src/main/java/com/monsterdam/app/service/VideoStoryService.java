...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.VideoStory}.
 */
public interface VideoStoryService extends LogicalDeletionService<VideoStoryDTO> {
    /**
     * Save a videoStory.
     *
