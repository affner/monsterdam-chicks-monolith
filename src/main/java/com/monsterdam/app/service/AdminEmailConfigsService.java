...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.AdminEmailConfigs}.
 */
public interface AdminEmailConfigsService extends LogicalDeletionService<AdminEmailConfigsDTO> {
    /**
