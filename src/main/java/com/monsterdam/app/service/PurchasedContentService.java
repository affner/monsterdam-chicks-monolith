...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.PurchasedContent}.
 */
public interface PurchasedContentService extends LogicalDeletionService<PurchasedContentDTO> {
    /**
