...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.SocialNetwork}.
 */
public interface SocialNetworkService extends LogicalDeletionService<SocialNetworkDTO> {
    /**
