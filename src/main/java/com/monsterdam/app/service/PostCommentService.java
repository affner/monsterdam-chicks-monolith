...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.PostComment}.
 */
public interface PostCommentService extends LogicalDeletionService<PostCommentDTO> {
    /**
     * Save a postComment.
     *
