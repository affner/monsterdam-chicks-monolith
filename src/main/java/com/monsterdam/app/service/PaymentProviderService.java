...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.PaymentProvider}.
 */
public interface PaymentProviderService extends LogicalDeletionService<PaymentProviderDTO> {
    /**
