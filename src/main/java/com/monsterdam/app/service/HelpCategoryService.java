...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.HelpCategory}.
 */
public interface HelpCategoryService extends LogicalDeletionService<HelpCategoryDTO> {
    /**
     * Save a helpCategory.
     *
