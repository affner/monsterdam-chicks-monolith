...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.UserAssociation}.
 */
public interface UserAssociationService extends LogicalDeletionService<UserAssociationDTO> {
    /**
