...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.PersonalSocialLinks}.
 */
public interface PersonalSocialLinksService extends LogicalDeletionService<PersonalSocialLinksDTO> {
    /**
