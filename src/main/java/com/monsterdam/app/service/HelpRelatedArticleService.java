...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.HelpRelatedArticle}.
 */
public interface HelpRelatedArticleService extends LogicalDeletionService<HelpRelatedArticleDTO> {
    /**
