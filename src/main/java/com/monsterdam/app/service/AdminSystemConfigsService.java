...
/**
 * Service Interface for managing {@link com.monsterdam.app.domain.AdminSystemConfigs}.
 */
public interface AdminSystemConfigsService extends LogicalDeletionService<AdminSystemConfigsDTO> {
    /**
