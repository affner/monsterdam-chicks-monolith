        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/viewer/**")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/creator/**")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/sets/**")).permitAll()
