...
describe('IdentityDocument e2e test', () => {
  ...
  const identityDocumentSample = {
    ...
    createdDate: '2025-12-09T15:01:57.523Z',
  };
  ...
  describe('new IdentityDocument page', () => {
    ...
    it('should create an instance of IdentityDocument', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T14:22');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T14:22');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T12:52');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T12:52');
