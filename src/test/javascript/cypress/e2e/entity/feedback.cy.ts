...
describe('Feedback e2e test', () => {
  ...
  const feedbackSample = { content: 'general', feedbackDate: '2025-12-15T21:47:35.784Z', createdDate: '2025-12-15T13:11:55.332Z' };
  ...
  describe('new Feedback page', () => {
    ...
    it('should create an instance of Feedback', () => {
      ...
      cy.get(`[data-cy="feedbackDate"]`).type('2025-12-15T07:56');
      cy.get(`[data-cy="feedbackDate"]`).blur();
      cy.get(`[data-cy="feedbackDate"]`).should('have.value', '2025-12-15T07:56');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T22:49');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T22:49');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T09:28');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T09:28');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T16:46');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T16:46');
