...
describe('UserReport e2e test', () => {
  ...
  const userReportSample = {
    status: 'ACTION_TAKEN',
    createdDate: '2025-12-15T22:54:27.046Z',
    reportCategory: 'MULTIMEDIA_REPORT',
    reporterId: 18394,
    reportedId: 738,
  };
  ...
  describe('new UserReport page', () => {
    ...
    it('should create an instance of UserReport', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-16T01:56');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-16T01:56');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T18:30');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T18:30');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-16T04:50');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-16T04:50');
