...
describe('MoneyWithdraw e2e test', () => {
  ...
  const moneyWithdrawSample = {
    amount: 8937.16,
    createdDate: '2025-12-09T16:37:55.721Z',
    isDeleted: false,
  ...
  describe('new MoneyWithdraw page', () => {
    ...
    it('should create an instance of MoneyWithdraw', () => {
      cy.get(`[data-cy="amount"]`).type('11448.65');
      cy.get(`[data-cy="amount"]`).should('have.value', '11448.65');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T10:47');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T10:47');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T23:04');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T23:04');

      cy.get(`[data-cy="createdBy"]`).type('bank');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'bank');

      cy.get(`[data-cy="lastModifiedBy"]`).type('majestically wherever controvert');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'majestically wherever controvert');
