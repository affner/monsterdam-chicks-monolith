...
describe('Auction e2e test', () => {
  ...
  const auctionSample = {
    ...
    startDate: '2025-12-16T01:12:58.075Z',
    endDate: '2025-12-15T12:23:40.800Z',
    auctionStatus: 'ACTIVE',
    createdDate: '2025-12-16T03:41:07.243Z',
  };
  ...
  describe('new Auction page', () => {
    ...
    it('should create an instance of Auction', () => {
      ...
      cy.get(`[data-cy="startDate"]`).type('2025-12-15T15:11');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2025-12-15T15:11');

      cy.get(`[data-cy="endDate"]`).type('2025-12-15T16:59');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2025-12-15T16:59');

      cy.get(`[data-cy="auctionStatus"]`).select('CANCELLED');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T17:11');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T17:11');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-16T01:51');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-16T01:51');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-16T01:22');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-16T01:22');
