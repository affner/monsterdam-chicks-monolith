...
describe('PlatformAdminUser e2e test', () => {
  ...
  const platformAdminUserSample = {
    ...
    emailAddress: 'and',
    gender: 'MALE',
    lastLoginDate: '2025-12-10T07:44:53.618Z',
    birthDate: '2025-12-09',
    createdDate: '2025-12-09T20:29:40.611Z',
    isDeleted: false,
  };
  ...
  describe('new PlatformAdminUser page', () => {
    ...
    it('should create an instance of PlatformAdminUser', () => {
      ...
      cy.get(`[data-cy="lastLoginDate"]`).type('2025-12-10T04:43');
      cy.get(`[data-cy="lastLoginDate"]`).blur();
      cy.get(`[data-cy="lastLoginDate"]`).should('have.value', '2025-12-10T04:43');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T08:01');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T08:01');
