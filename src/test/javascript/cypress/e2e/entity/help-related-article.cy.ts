...
describe('HelpRelatedArticle e2e test', () => {
  ...
  const helpRelatedArticleSample = { title: 'biodegrade um psst', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=' };
  ...
  describe('new HelpRelatedArticle page', () => {
    ...
    it('should create an instance of HelpRelatedArticle', () => {
      cy.get(`[data-cy="title"]`).type('apt of state');
      cy.get(`[data-cy="title"]`).should('have.value', 'apt of state');
