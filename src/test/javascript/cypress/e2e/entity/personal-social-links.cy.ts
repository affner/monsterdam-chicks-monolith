...
describe('PersonalSocialLinks e2e test', () => {
  ...
  const personalSocialLinksSample = { socialLink: 'ack', createdDate: '2025-12-15T21:51:23.404Z' };
  ...
  describe('new PersonalSocialLinks page', () => {
    ...
    it('should create an instance of PersonalSocialLinks', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T19:59');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T19:59');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T08:28');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T08:28');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T06:46');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T06:46');
