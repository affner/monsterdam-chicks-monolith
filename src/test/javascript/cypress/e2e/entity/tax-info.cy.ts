...
describe('TaxInfo e2e test', () => {
  ...
  const taxInfoSample = { taxType: 'VAT', createdDate: '2025-12-15T18:46:52.230Z' };
  ...
  describe('new TaxInfo page', () => {
    ...
    it('should create an instance of TaxInfo', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-16T04:50');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-16T04:50');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-16T05:25');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-16T05:25');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T13:31');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T13:31');
