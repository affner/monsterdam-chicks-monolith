...
describe('PaymentProvider e2e test', () => {
  ...
  const paymentProviderSample = {
    ...
    createdDate: '2025-12-09T12:49:51.362Z',
    isDeleted: false,
  };
  ...
  describe('new PaymentProvider page', () => {
    ...
    it('should create an instance of PaymentProvider', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T00:42');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T00:42');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T13:25');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T13:25');
