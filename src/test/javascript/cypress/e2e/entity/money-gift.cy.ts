...
describe('MoneyGift e2e test', () => {
  ...
  const moneyGiftSample = { createdDate: '2025-12-09T16:41:16.919Z', isDeleted: true, viewerId: 6511, creatorId: 3290 };
  ...
  describe('new MoneyGift page', () => {
    ...
    it('should create an instance of MoneyGift', () => {
      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T19:06');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T19:06');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T11:32');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T11:32');

      cy.get(`[data-cy="createdBy"]`).type('broadly noteworthy for');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'broadly noteworthy for');

      cy.get(`[data-cy="lastModifiedBy"]`).type('profuse terrorise um');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'profuse terrorise um');

      cy.get(`[data-cy="isDeleted"]`).should('not.be.checked');
      cy.get(`[data-cy="isDeleted"]`).click();
      cy.get(`[data-cy="isDeleted"]`).should('be.checked');

      cy.get(`[data-cy="messageId"]`).type('26153');
      cy.get(`[data-cy="messageId"]`).should('have.value', '26153');

      cy.get(`[data-cy="postId"]`).type('15487');
      cy.get(`[data-cy="postId"]`).should('have.value', '15487');

      cy.get(`[data-cy="viewerId"]`).type('5124');
      cy.get(`[data-cy="viewerId"]`).should('have.value', '5124');

      cy.get(`[data-cy="creatorId"]`).type('28043');
      cy.get(`[data-cy="creatorId"]`).should('have.value', '28043');
