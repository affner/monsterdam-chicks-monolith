...
describe('IdentityDocumentReview e2e test', () => {
  ...
  const identityDocumentReviewSample = { createdDate: '2025-12-09T11:29:36.175Z' };
  ...
  describe('new IdentityDocumentReview page', () => {
    ...
    it('should create an instance of IdentityDocumentReview', () => {
      ...
      cy.get(`[data-cy="resolutionDate"]`).type('2025-12-10T03:39');
      cy.get(`[data-cy="resolutionDate"]`).blur();
      cy.get(`[data-cy="resolutionDate"]`).should('have.value', '2025-12-10T03:39');

      cy.get(`[data-cy="reviewStatus"]`).select('REVIEWING');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T02:37');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T02:37');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-10T00:33');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-10T00:33');
