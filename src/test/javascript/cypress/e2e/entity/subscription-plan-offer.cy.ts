...
describe('SubscriptionPlanOffer e2e test', () => {
  ...
  const subscriptionPlanOfferSample = {
    ...
    createdDate: '2025-12-09T22:53:43.547Z',
    isDeleted: true,
  };
  ...
  describe('new SubscriptionPlanOffer page', () => {
    ...
    it('should create an instance of SubscriptionPlanOffer', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T22:58');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T22:58');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T18:46');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T18:46');
