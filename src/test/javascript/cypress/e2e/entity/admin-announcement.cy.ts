...
describe('AdminAnnouncement e2e test', () => {
  ...
  const adminAnnouncementSample = {
    ...
    createdDate: '2025-12-15T10:29:50.971Z',
    announcerId: 20173,
  };
  ...
  describe('new AdminAnnouncement page', () => {
    ...
    it('should create an instance of AdminAnnouncement', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T14:33');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T14:33');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-16T01:16');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-16T01:16');
