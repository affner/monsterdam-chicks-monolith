...
describe('AdminAnnouncement e2e test', () => {
  ...
  const adminAnnouncementSample = {
    ...
    title: 'attribute palate',
    content: 'avaricious access pro',
    createdDate: '2025-12-09T13:49:12.971Z',
    announcerId: 20173,
  };
  ...
  describe('new AdminAnnouncement page', () => {
    ...
    it('should create an instance of AdminAnnouncement', () => {
      ...
      cy.get(`[data-cy="title"]`).type('analyse roughly');
      cy.get(`[data-cy="title"]`).should('have.value', 'analyse roughly');

      cy.get(`[data-cy="content"]`).type('gullible hydrolyze forgo');
      cy.get(`[data-cy="content"]`).should('have.value', 'gullible hydrolyze forgo');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T17:52');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T17:52');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-10T04:36');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-10T04:36');

      cy.get(`[data-cy="createdBy"]`).type('although');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'although');

      cy.get(`[data-cy="lastModifiedBy"]`).type('wedding');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'wedding');

      cy.get(`[data-cy="announcerId"]`).type('19773');
      cy.get(`[data-cy="announcerId"]`).should('have.value', '19773');
