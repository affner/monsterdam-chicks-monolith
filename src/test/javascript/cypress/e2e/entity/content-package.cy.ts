...
describe('ContentPackage e2e test', () => {
  ...
  const contentPackageSample = { isPaidContent: true, createdDate: '2025-12-10T02:34:17.316Z', isDeleted: true };
  ...
  describe('new ContentPackage page', () => {
    ...
    it('should create an instance of ContentPackage', () => {
      cy.get(`[data-cy="amount"]`).type('31093.24');
      cy.get(`[data-cy="amount"]`).should('have.value', '31093.24');

      cy.get(`[data-cy="videoCount"]`).type('21724');
      cy.get(`[data-cy="videoCount"]`).should('have.value', '21724');

      cy.get(`[data-cy="imageCount"]`).type('21155');
      cy.get(`[data-cy="imageCount"]`).should('have.value', '21155');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T01:56');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T01:56');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-10T05:56');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-10T05:56');

      cy.get(`[data-cy="createdBy"]`).type('trustworthy refer');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'trustworthy refer');

      cy.get(`[data-cy="lastModifiedBy"]`).type('other tough');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'other tough');

      cy.get(`[data-cy="isDeleted"]`).should('not.be.checked');
      cy.get(`[data-cy="isDeleted"]`).click();
      cy.get(`[data-cy="isDeleted"]`).should('be.checked');

      cy.get(`[data-cy="messageId"]`).type('15344');
      cy.get(`[data-cy="messageId"]`).should('have.value', '15344');

      cy.get(`[data-cy="postId"]`).type('9545');
      cy.get(`[data-cy="postId"]`).should('have.value', '9545');
