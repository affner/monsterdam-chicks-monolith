...
describe('HashTag e2e test', () => {
  ...
  const hashTagSample = { tagName: 'yawn besides', hashtagType: 'USER', createdDate: '2025-12-09T13:12:01.850Z', isDeleted: true };
  ...
  describe('new HashTag page', () => {
    ...
    it('should create an instance of HashTag', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T08:19');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T08:19');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-10T08:29');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-10T08:29');
