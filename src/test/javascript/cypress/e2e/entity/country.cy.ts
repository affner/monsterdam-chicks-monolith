...
describe('Country e2e test', () => {
  ...
  const countrySample = {
    ...
    alpha2Code: 'go',
    alpha3Code: 'dis',
    createdDate: '2025-12-09T12:38:16.902Z',
    isDeleted: true,
  };
  ...
  describe('new Country page', () => {
    ...
    it('should create an instance of Country', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T11:23');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T11:23');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T21:48');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T21:48');
