...
describe('PaymentMethod e2e test', () => {
  ...
  const paymentMethodSample = {
    methodName: 'idolized till blah',
    tokenText: 'amid fully manner',
    createdDate: '2025-12-10T03:29:10.936Z',
    isDeleted: true,
  };
  ...
  describe('new PaymentMethod page', () => {
    ...
    it('should create an instance of PaymentMethod', () => {
      ...
      cy.get(`[data-cy="expirationDate"]`).type('2025-12-09');
      cy.get(`[data-cy="expirationDate"]`).blur();
      cy.get(`[data-cy="expirationDate"]`).should('have.value', '2025-12-09');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T01:56');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T01:56');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-10T00:48');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-10T00:48');
