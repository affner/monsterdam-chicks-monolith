...
describe('SocialNetwork e2e test', () => {
  ...
  const socialNetworkSample = {
    ...
    createdDate: '2025-12-15T12:54:35.992Z',
  };
  ...
  describe('new SocialNetwork page', () => {
    ...
    it('should create an instance of SocialNetwork', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T13:01');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T13:01');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-16T03:00');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-16T03:00');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T21:59');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T21:59');
