...
describe('TrialLink e2e test', () => {
  ...
  const trialLinkSample = {
    ...
    endDate: '2025-12-15',
    isUsed: false,
    createdDate: '2025-12-15T10:22:59.534Z',
  };
  ...
  describe('new TrialLink page', () => {
    ...
    it('should create an instance of TrialLink', () => {
      ...
      cy.get(`[data-cy="startDate"]`).type('2025-12-16');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2025-12-16');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T12:29');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T12:29');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T19:00');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T19:00');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T07:00');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T07:00');
