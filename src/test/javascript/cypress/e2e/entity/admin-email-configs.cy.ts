...
describe('AdminEmailConfigs e2e test', () => {
  ...
  const adminEmailConfigsSample = {
    ...
    createdDate: '2025-12-15T22:22:10.727Z',
  };
  ...
  describe('new AdminEmailConfigs page', () => {
    ...
    it('should create an instance of AdminEmailConfigs', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-16T03:35');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-16T03:35');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-16T07:09');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-16T07:09');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T12:41');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T12:41');
