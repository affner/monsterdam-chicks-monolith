...
describe('SpecialAward e2e test', () => {
  ...
  const specialAwardSample = {
    ...
    endDate: '2025-12-15',
    createdDate: '2025-12-15T09:42:31.699Z',
    specialTitleId: 29052,
  };
  ...
  describe('new SpecialAward page', () => {
    ...
    it('should create an instance of SpecialAward', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T11:25');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T11:25');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T19:56');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T19:56');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T19:18');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T19:18');
