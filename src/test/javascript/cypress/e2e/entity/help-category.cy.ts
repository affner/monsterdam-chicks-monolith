...
describe('HelpCategory e2e test', () => {
  ...
  const helpCategorySample = { name: 'inasmuch boyfriend minor', isDeleted: true };
  ...
  describe('new HelpCategory page', () => {
    ...
    it('should create an instance of HelpCategory', () => {
      cy.get(`[data-cy="name"]`).type('rundown above uh-huh');
      cy.get(`[data-cy="name"]`).should('have.value', 'rundown above uh-huh');
