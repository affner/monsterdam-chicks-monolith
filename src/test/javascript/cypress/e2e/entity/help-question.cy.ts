...
describe('HelpQuestion e2e test', () => {
  ...
  const helpQuestionSample = {
    title: 'per seemingly extremely',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    createdDate: '2025-12-16T02:21:54.074Z',
  };
  ...
  describe('new HelpQuestion page', () => {
    ...
    it('should create an instance of HelpQuestion', () => {
      cy.get(`[data-cy="title"]`).type('absentmindedly t-shirt');
      cy.get(`[data-cy="title"]`).should('have.value', 'absentmindedly t-shirt');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-16T02:37');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-16T02:37');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T11:15');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T11:15');

      cy.get(`[data-cy="createdBy"]`).type('ugh oof embody');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'ugh oof embody');

      cy.get(`[data-cy="lastModifiedBy"]`).type('elevation institute');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'elevation institute');

      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T15:01');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T15:01');
