...
describe('HelpQuestion e2e test', () => {
  ...
  const helpQuestionSample = { title: 'yet', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', isDeleted: true };
  ...
  describe('new HelpQuestion page', () => {
    ...
    it('should create an instance of HelpQuestion', () => {
      cy.get(`[data-cy="title"]`).type('zowie masquerade surprisingly');
      cy.get(`[data-cy="title"]`).should('have.value', 'zowie masquerade surprisingly');
