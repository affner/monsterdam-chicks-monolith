...
describe('SubscriptionBundle e2e test', () => {
  ...
  const subscriptionBundleSample = { amount: 508.71, duration: 14612, createdDate: '2025-12-15T15:14:41.375Z' };
  ...
  describe('new SubscriptionBundle page', () => {
    ...
    it('should create an instance of SubscriptionBundle', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-15T11:11');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-15T11:11');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-15T06:35');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-15T06:35');
      ...
      cy.get(`[data-cy="deletedDate"]`).type('2025-12-15T17:27');
      cy.get(`[data-cy="deletedDate"]`).blur();
      cy.get(`[data-cy="deletedDate"]`).should('have.value', '2025-12-15T17:27');
