...
describe('PurchasedContent e2e test', () => {
  ...
  const purchasedContentSample = { createdDate: '2025-12-09T22:14:58.103Z', isDeleted: false, viewerId: 9896 };
  ...
  describe('new PurchasedContent page', () => {
    ...
    it('should create an instance of PurchasedContent', () => {
      cy.get(`[data-cy="rating"]`).type('16508.99');
      cy.get(`[data-cy="rating"]`).should('have.value', '16508.99');

      cy.get(`[data-cy="createdDate"]`).type('2025-12-10T04:08');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-10T04:08');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T20:04');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T20:04');

      cy.get(`[data-cy="createdBy"]`).type('beneath cuckoo');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'beneath cuckoo');

      cy.get(`[data-cy="lastModifiedBy"]`).type('to hourly');
      cy.get(`[data-cy="lastModifiedBy"]`).should('have.value', 'to hourly');

      cy.get(`[data-cy="isDeleted"]`).should('not.be.checked');
      cy.get(`[data-cy="isDeleted"]`).click();
      cy.get(`[data-cy="isDeleted"]`).should('be.checked');

      cy.get(`[data-cy="viewerId"]`).type('22509');
      cy.get(`[data-cy="viewerId"]`).should('have.value', '22509');
