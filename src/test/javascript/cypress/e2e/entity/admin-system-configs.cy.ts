...
describe('AdminSystemConfigs e2e test', () => {
  ...
  const adminSystemConfigsSample = {
    ...
    createdDate: '2025-12-09T22:14:31.131Z',
  };
  ...
  describe('new AdminSystemConfigs page', () => {
    ...
    it('should create an instance of AdminSystemConfigs', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2025-12-09T16:38');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2025-12-09T16:38');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2025-12-09T14:44');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2025-12-09T14:44');
