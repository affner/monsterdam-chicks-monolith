...
describe('DocumentReviewObservation e2e test', () => {
  ...
  const documentReviewObservationSample = { comment: 'testimonial between sham' };
  ...
  describe('new DocumentReviewObservation page', () => {
    ...
    it('should create an instance of DocumentReviewObservation', () => {
      cy.get(`[data-cy="commentDate"]`).type('2025-12-09T15:56');
      cy.get(`[data-cy="commentDate"]`).blur();
      cy.get(`[data-cy="commentDate"]`).should('have.value', '2025-12-09T15:56');

      cy.get(`[data-cy="comment"]`).type('wisely');
      cy.get(`[data-cy="comment"]`).should('have.value', 'wisely');
