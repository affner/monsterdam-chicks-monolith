...
class UserMapperTest {
    ...
    void init() {
        ...
        authority.setName(AuthoritiesConstants.VIEWER);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(convertedUserDto.getAuthorities()).containsExactly(AuthoritiesConstants.VIEWER);
    }
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(convertedUser.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.VIEWER);
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(convertedUser.getAuthorities().iterator().next().getName()).isEqualTo(AuthoritiesConstants.VIEWER);
    }
