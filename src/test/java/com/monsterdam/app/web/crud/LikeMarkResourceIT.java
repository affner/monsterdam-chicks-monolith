...
class LikeMarkResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/crud/like-marks";
    ...
    public static LikeMark createUpdatedEntity(EntityManager em) {
        LikeMark updatedLikeMark = new LikeMark()
        ...
        updatedLikeMark.setLiker(userLite);
        return updatedLikeMark;
    }
