...
class HelpSubcategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/crud/help-subcategories";
    ...
    void checkCreatedDateIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        helpSubcategory.setCreatedDate(null);
    ...
    void partialUpdateHelpSubcategoryWithPatch() throws Exception {
        ...
        partialUpdatedHelpSubcategory.name(UPDATED_NAME).createdBy(UPDATED_CREATED_BY);
