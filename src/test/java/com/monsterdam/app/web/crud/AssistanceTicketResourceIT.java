...
class AssistanceTicketResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/crud/assistance-tickets";
    ...
    public static AssistanceTicket createEntity(EntityManager em) {
        ...
        assistanceTicket.setUser(userLite);
    ...
    public static AssistanceTicket createUpdatedEntity(EntityManager em) {
        AssistanceTicket updatedAssistanceTicket = new AssistanceTicket()
        ...
        updatedAssistanceTicket.setUser(userLite);
        return updatedAssistanceTicket;
    }
