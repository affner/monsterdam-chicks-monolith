...
class BookMarkResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/crud/book-marks";
    ...
    void partialUpdateBookMarkWithPatch() throws Exception {
        ...
        partialUpdatedBookMark.lastModifiedBy(UPDATED_LAST_MODIFIED_BY).deletedDate(UPDATED_DELETED_DATE);
