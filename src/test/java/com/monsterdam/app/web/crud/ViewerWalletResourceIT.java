...
class ViewerWalletResourceIT {
    ...
    private static final ViewerWalletTransactionType UPDATED_TRANSACTION_TYPE = ViewerWalletTransactionType.PURCHASE;
    ...
    private static final String ENTITY_API_URL = "/api/crud/viewer-wallets";
    ...
    void partialUpdateViewerWalletWithPatch() throws Exception {
        ...
        partialUpdatedViewerWallet.currency(UPDATED_CURRENCY).lastModifiedBy(UPDATED_LAST_MODIFIED_BY).deletedDate(UPDATED_DELETED_DATE);
