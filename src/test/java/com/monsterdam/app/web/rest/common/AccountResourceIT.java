package com.monsterdam.app.web.rest.common;
...
import com.monsterdam.app.web.rest.WithUnauthenticatedMockUser;
...
class AccountResourceIT {
    ...
    void testNonAuthenticatedUser() throws Exception {
        restAccountMockMvc.perform(get("/api/bff/open/authenticate")).andExpect(status().isUnauthorized());
    }

    @Test
    @WithMockUser(TEST_USER_LOGIN)
    void testAuthenticatedUser() throws Exception {
        restAccountMockMvc.perform(get("/api/bff/open/authenticate").with(request -> request)).andExpect(status().isNoContent());
    }
    ...
    void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc
            .perform(get("/api/bff/common/account").accept(MediaType.APPLICATION_JSON))
    ...
    void testGetUnknownAccount() throws Exception {
        restAccountMockMvc
            .perform(get("/api/bff/common/account").accept(MediaType.APPLICATION_PROBLEM_JSON))
    ...
    void testRegisterValid() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/bff/common/register").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(validUser)))
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/bff/common/register").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(invalidUser)))
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        // First user
        restAccountMockMvc
            .perform(post("/api/bff/common/register").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(firstUser)))
            .andExpect(status().isCreated());

        // Second (non activated) user
        restAccountMockMvc
            .perform(post("/api/bff/common/register").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(secondUser)))
            .andExpect(status().isCreated());
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.VIEWER).orElseThrow());
    ...
    void testActivateAccount() throws Exception {
        ...
        restAccountMockMvc.perform(get("/api/bff/common/activate?key={activationKey}", activationKey)).andExpect(status().isOk());
    ...
    void testActivateAccountWithWrongKey() throws Exception {
        restAccountMockMvc.perform(get("/api/bff/common/activate?key=wrongActivationKey")).andExpect(status().isInternalServerError());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/bff/common/account").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(userDTO)))
            .andExpect(status().isOk());
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restAccountMockMvc
            .perform(
                post("/api/bff/common/account/change-password")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void testRequestPasswordReset() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/bff/common/account/reset-password/init").content("password-reset@example.com"))
            .andExpect(status().isOk());
    ...
    void testRequestPasswordResetUpperCaseEmail() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/bff/common/account/reset-password/init").content("password-reset-upper-case@EXAMPLE.COM"))
            .andExpect(status().isOk());
    ...
    void testRequestPasswordResetWrongEmail() throws Exception {
        restAccountMockMvc
            .perform(post("/api/bff/common/account/reset-password/init").content("password-reset-wrong-email@example.com"))
            .andExpect(status().isOk());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        restAccountMockMvc
            .perform(
                post("/api/bff/common/account/reset-password/finish")
                    .contentType(MediaType.APPLICATION_JSON)
