...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorities.add(AuthoritiesConstants.SUPPORT_ADMIN);
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(AuthoritiesConstants.SUPPORT_ADMIN));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SUPPORT_ADMIN));
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.SUPPORT_ADMIN));
