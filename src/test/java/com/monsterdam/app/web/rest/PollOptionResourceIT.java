...
class PollOptionResourceIT {
    ...
    public static PollOption createEntity() {
        return new PollOption().optionDescription(DEFAULT_OPTION_DESCRIPTION).voteCount(DEFAULT_VOTE_COUNT);
    }
    ...
    public static PollOption createUpdatedEntity() {
        return new PollOption().optionDescription(UPDATED_OPTION_DESCRIPTION).voteCount(UPDATED_VOTE_COUNT);
    }
