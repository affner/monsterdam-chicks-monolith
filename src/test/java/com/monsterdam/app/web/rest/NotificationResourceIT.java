...
class NotificationResourceIT {
    ...
    private static final Long DEFAULT_COMMENTED_USER_ID = 1L;
    private static final Long UPDATED_COMMENTED_USER_ID = 2L;

    private static final Long DEFAULT_MESSAGED_USER_ID = 1L;
    private static final Long UPDATED_MESSAGED_USER_ID = 2L;

    private static final Long DEFAULT_MENTIONER_ID_IN_POST = 1L;
    private static final Long UPDATED_MENTIONER_ID_IN_POST = 2L;

    private static final Long DEFAULT_MENTIONER_ID_IN_COMMENT = 1L;
    private static final Long UPDATED_MENTIONER_ID_IN_COMMENT = 2L;
    ...
    public static Notification createEntity() {
        return new Notification()
            ...
            .commentedUserId(DEFAULT_COMMENTED_USER_ID)
            .messagedUserId(DEFAULT_MESSAGED_USER_ID)
            .mentionerIdInPost(DEFAULT_MENTIONER_ID_IN_POST)
            .mentionerIdInComment(DEFAULT_MENTIONER_ID_IN_COMMENT);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification()
            ...
            .commentedUserId(UPDATED_COMMENTED_USER_ID)
            .messagedUserId(UPDATED_MESSAGED_USER_ID)
            .mentionerIdInPost(UPDATED_MENTIONER_ID_IN_POST)
            .mentionerIdInComment(UPDATED_MENTIONER_ID_IN_COMMENT);
    }
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].commentedUserId").value(hasItem(DEFAULT_COMMENTED_USER_ID.intValue())))
            .andExpect(jsonPath("$.[*].messagedUserId").value(hasItem(DEFAULT_MESSAGED_USER_ID.intValue())))
            .andExpect(jsonPath("$.[*].mentionerIdInPost").value(hasItem(DEFAULT_MENTIONER_ID_IN_POST.intValue())))
            .andExpect(jsonPath("$.[*].mentionerIdInComment").value(hasItem(DEFAULT_MENTIONER_ID_IN_COMMENT.intValue())));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.commentedUserId").value(DEFAULT_COMMENTED_USER_ID.intValue()))
            .andExpect(jsonPath("$.messagedUserId").value(DEFAULT_MESSAGED_USER_ID.intValue()))
            .andExpect(jsonPath("$.mentionerIdInPost").value(DEFAULT_MENTIONER_ID_IN_POST.intValue()))
            .andExpect(jsonPath("$.mentionerIdInComment").value(DEFAULT_MENTIONER_ID_IN_COMMENT.intValue()));
    }
