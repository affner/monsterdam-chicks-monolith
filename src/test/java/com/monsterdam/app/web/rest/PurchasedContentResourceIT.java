...
class PurchasedContentResourceIT {
     ...
     */
    public static PurchasedContent createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static PurchasedContent createUpdatedEntity() {
        return new PurchasedContent()
    ...
    void partialUpdatePurchasedContentWithPatch() throws Exception {
        ...
        partialUpdatedPurchasedContent.isDeleted(UPDATED_IS_DELETED).viewerId(UPDATED_VIEWER_ID);
