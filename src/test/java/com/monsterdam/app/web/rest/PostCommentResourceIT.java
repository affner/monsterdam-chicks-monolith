...
class PostCommentResourceIT {
    ...
    private static final Long DEFAULT_COMMENTER_ID = 1L;
    private static final Long UPDATED_COMMENTER_ID = 2L;
    ...
    public static PostComment createEntity() {
        return new PostComment()
            ...
            .commenterId(DEFAULT_COMMENTER_ID);
    }
    ...
    public static PostComment createUpdatedEntity() {
        return new PostComment()
            ...
            .commenterId(UPDATED_COMMENTER_ID);
    }
    ...
    @Test
    @Transactional
    void checkCommenterIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        postComment.setCommenterId(null);
    ...
    void getAllPostComments() throws Exception {
        ...
        restPostCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].commenterId").value(hasItem(DEFAULT_COMMENTER_ID.intValue())));
    }
    ...
    void getPostComment() throws Exception {
        ...
        restPostCommentMockMvc
            ...
            .andExpect(jsonPath("$.commenterId").value(DEFAULT_COMMENTER_ID.intValue()));
    }
