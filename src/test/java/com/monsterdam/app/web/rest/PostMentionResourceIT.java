...
class PostMentionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/post-mentions";
     ...
     */
    public static PostMention createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static PostMention createUpdatedEntity() {
        return new PostMention()
    ...
    void checkMentionedUserIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        postMention.setMentionedUserId(null);
