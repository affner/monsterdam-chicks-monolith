...
class CommentMentionResourceIT {
     ...
     */
    public static CommentMention createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CommentMention createUpdatedEntity() {
        return new CommentMention()
    ...
    void checkIsDeletedIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        commentMention.setIsDeleted(null);
    ...
    void checkMentionedUserIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        commentMention.setMentionedUserId(null);
