...
class PurchasedSubscriptionResourceIT {
     ...
     */
    public static PurchasedSubscription createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static PurchasedSubscription createUpdatedEntity() {
        return new PurchasedSubscription()
    ...
    @BeforeEach
    void initTest() {
        purchasedSubscription = createEntity();
    }
    ...
    void partialUpdatePurchasedSubscriptionWithPatch() throws Exception {
        ...
        partialUpdatedPurchasedSubscription.endDate(UPDATED_END_DATE).createdBy(UPDATED_CREATED_BY).creatorId(UPDATED_CREATOR_ID);
