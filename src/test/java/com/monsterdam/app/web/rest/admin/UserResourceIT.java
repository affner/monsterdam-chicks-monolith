...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.VIEWER));

        var returnedUserDTO = om.readValue(
            restUserMockMvc
                .perform(post("/api/bff/admin/users").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(userDTO)))
    ...
    void getAllUsers() throws Exception {
        ...
        // Get all the users
        restUserMockMvc
            .perform(get("/api/bff/admin/users?sort=id,desc").accept(MediaType.APPLICATION_JSON))
    ...
    void getUser() throws Exception {
        ...
        // Get the user
        restUserMockMvc
            .perform(get("/api/bff/admin/users/{login}", user.getLogin()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingUser() throws Exception {
        restUserMockMvc.perform(get("/api/bff/admin/users/unknown")).andExpect(status().isNotFound());
    }
    ...
    void updateUser() throws Exception {
        ...
        restUserMockMvc
            .perform(put("/api/bff/admin/users").contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(userDTO)))
            .andExpect(status().isOk());
    ...
    void deleteUser() throws Exception {
        ...
        // Delete the user
        restUserMockMvc
            .perform(delete("/api/bff/admin/users/{login}", user.getLogin()).accept(MediaType.APPLICATION_JSON))
