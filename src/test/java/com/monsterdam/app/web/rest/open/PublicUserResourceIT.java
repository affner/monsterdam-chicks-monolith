...
class PublicUserResourceIT {
    ...
    void getAllPublicUsers() throws Exception {
        ...
        // Get all the users
        restUserMockMvc
            .perform(get("/api/bff/open/users?sort=id,desc").accept(MediaType.APPLICATION_JSON))
    ...
    void getAllUsersSortedByParameters() throws Exception {
        ...
        restUserMockMvc
            .perform(get("/api/bff/open/users?sort=resetKey,desc").accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isBadRequest());
        restUserMockMvc
            .perform(get("/api/bff/open/users?sort=password,desc").accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isBadRequest());
        restUserMockMvc
            .perform(get("/api/bff/open/users?sort=resetKey,desc&sort=id,desc").accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isBadRequest());
        restUserMockMvc.perform(get("/api/bff/open/users?sort=id,desc").accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }
}
