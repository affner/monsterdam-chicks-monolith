...
public class HelpQuestionTestSamples {
    ...
    public static HelpQuestion getHelpQuestionSample1() {
        return new HelpQuestion().id(1L).title("title1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static HelpQuestion getHelpQuestionSample2() {
        return new HelpQuestion().id(2L).title("title2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
