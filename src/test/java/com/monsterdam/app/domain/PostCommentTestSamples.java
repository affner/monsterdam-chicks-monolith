...
public class PostCommentTestSamples {
    ...
    public static PostComment getPostCommentSample1() {
        return new PostComment().id(1L).likeCount(1).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static PostComment getPostCommentSample2() {
        return new PostComment().id(2L).likeCount(2).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
