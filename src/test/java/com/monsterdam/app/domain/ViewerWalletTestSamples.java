...
public class ViewerWalletTestSamples {
    ...
    public static ViewerWallet getViewerWalletSample1() {
        return new ViewerWallet().id(1L).currency("currency1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static ViewerWallet getViewerWalletSample2() {
        return new ViewerWallet().id(2L).currency("currency2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
