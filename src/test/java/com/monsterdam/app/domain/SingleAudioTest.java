...
class SingleAudioTest {
    ...
    void creatorTest() {
        ...
        singleAudio.setCreator(userLiteBack);
        assertThat(singleAudio.getCreator()).isEqualTo(userLiteBack);

        singleAudio.creator(null);
        assertThat(singleAudio.getCreator()).isNull();
    }
}
