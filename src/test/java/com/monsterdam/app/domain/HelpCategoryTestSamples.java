...
public class HelpCategoryTestSamples {
    ...
    public static HelpCategory getHelpCategorySample1() {
        return new HelpCategory().id(1L).name("name1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static HelpCategory getHelpCategorySample2() {
        return new HelpCategory().id(2L).name("name2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
