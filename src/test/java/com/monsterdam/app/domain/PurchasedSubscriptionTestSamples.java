...
public class PurchasedSubscriptionTestSamples {
    ...
    public static PurchasedSubscription getPurchasedSubscriptionSample1() {
        return new PurchasedSubscription().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static PurchasedSubscription getPurchasedSubscriptionSample2() {
        return new PurchasedSubscription().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
