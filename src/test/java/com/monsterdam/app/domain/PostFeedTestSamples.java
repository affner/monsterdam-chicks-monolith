...
public class PostFeedTestSamples {
    ...
    public static PostFeed getPostFeedSample1() {
        return new PostFeed().id(1L).likeCount(1).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static PostFeed getPostFeedSample2() {
        return new PostFeed().id(2L).likeCount(2).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
