...
public class MoneyEarningTestSamples {
    ...
    public static MoneyEarning getMoneyEarningSample1() {
        return new MoneyEarning().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static MoneyEarning getMoneyEarningSample2() {
        return new MoneyEarning().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
