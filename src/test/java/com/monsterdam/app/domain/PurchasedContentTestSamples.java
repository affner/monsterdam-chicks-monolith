...
public class PurchasedContentTestSamples {
    ...
    public static PurchasedContent getPurchasedContentSample1() {
        return new PurchasedContent().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1").viewerId(1L);
    }

    public static PurchasedContent getPurchasedContentSample2() {
        return new PurchasedContent().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2").viewerId(2L);
    }
