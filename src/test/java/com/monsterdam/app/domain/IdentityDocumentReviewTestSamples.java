...
public class IdentityDocumentReviewTestSamples {
    ...
    public static IdentityDocumentReview getIdentityDocumentReviewSample1() {
        return new IdentityDocumentReview().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1").ticketId(1L);
    }

    public static IdentityDocumentReview getIdentityDocumentReviewSample2() {
        return new IdentityDocumentReview().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2").ticketId(2L);
    }
