...
public class DirectMessageTestSamples {
    ...
    public static DirectMessage getDirectMessageSample1() {
        return new DirectMessage().id(1L).likeCount(1).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1").repliedStoryId(1L);
    }

    public static DirectMessage getDirectMessageSample2() {
        return new DirectMessage().id(2L).likeCount(2).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2").repliedStoryId(2L);
    }
