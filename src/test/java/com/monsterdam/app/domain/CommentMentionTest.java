...
class CommentMentionTest {
    ...
    void mentionedUserTest() {
        ...
        commentMention.setMentionedUser(userLiteBack);
        assertThat(commentMention.getMentionedUser()).isEqualTo(userLiteBack);

        commentMention.mentionedUser(null);
        assertThat(commentMention.getMentionedUser()).isNull();
    }
}
