...
public class ChatRoomTestSamples {
    ...
    public static ChatRoom getChatRoomSample1() {
        return new ChatRoom().id(1L).lastAction("lastAction1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1").participantId(1L);
    }

    public static ChatRoom getChatRoomSample2() {
        return new ChatRoom().id(2L).lastAction("lastAction2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2").participantId(2L);
    }
