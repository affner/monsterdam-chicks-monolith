...
public class StateUserRelationTestSamples {
    ...
    public static StateUserRelation getStateUserRelationSample1() {
        return new StateUserRelation().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static StateUserRelation getStateUserRelationSample2() {
        return new StateUserRelation().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
