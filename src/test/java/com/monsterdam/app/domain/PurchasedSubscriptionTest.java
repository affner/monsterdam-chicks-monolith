...
class PurchasedSubscriptionTest {
    ...
    void viewerTest() {
        ...
        purchasedSubscription.setViewer(userLiteBack);
        assertThat(purchasedSubscription.getViewer()).isEqualTo(userLiteBack);
    ...
    void creatorTest() {
        ...
        purchasedSubscription.setCreator(userLiteBack);
        assertThat(purchasedSubscription.getCreator()).isEqualTo(userLiteBack);

        purchasedSubscription.creator(null);
        assertThat(purchasedSubscription.getCreator()).isNull();
    }
