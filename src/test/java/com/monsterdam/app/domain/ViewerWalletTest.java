...
class ViewerWalletTest {
    ...
    void viewerTest() {
        ...
        viewerWallet.setViewer(userLiteBack);
        assertThat(viewerWallet.getViewer()).isEqualTo(userLiteBack);

        viewerWallet.viewer(null);
        assertThat(viewerWallet.getViewer()).isNull();
    }
}
